      ...
      <div className="container mx-auto">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="space-y-6 text-lg text-gray-600">
            ...
            <p>
              Using census surveys or community insights, each team explores the <span className="italic text-[#2f4f97]">root of a specific challenge</span> and builds a solution. That could be a new data collection tool, a community program, or a pilot initiative backed by a clear <span className="font-bold underline decoration-[#2f4f97] decoration-2"> <a href="https://marcushumanities12.weebly.com/uploads/3/7/9/0/37903231/economic_policy_-_how_do_i_do_this.pdf" target="_blank" rel="noopener noreferrer">policy proposal</a></span> that could be presented and adopted by governments, institutions, or local organizations.
            </p>
            <p>
